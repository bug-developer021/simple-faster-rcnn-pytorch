    ...
    * :obj:`total_loss`: The sum of 4 loss above.
    ...
    def forward(self, imgs, bboxes, labels, scale):
        ...
        * :math:`R` is the number of bounding boxes per image.
        ...
        # gt_rpn_loc为anchor_target_creator函数得到2000个anchor与bbox的偏移量，
        # rpn_sigma=1.
...
# 只将前景 Anchor/ROIs 的位置放入到损失函数的计算中来
# 方法就是只给前景 Anchor/ROIs 的in_weight设置为 1，这样就可以完成loc_loss的求和计算。
